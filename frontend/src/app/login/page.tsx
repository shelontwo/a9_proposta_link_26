        ...
        <div className="space-y-4">
          ...
          <div className="relative">
            ...
            <div className="relative flex justify-center text-sm">
              <span className="px-4 bg-brand-darkgray text-brand-gray">Acesso exclusivo @a9p.com.br</span>
            </div>
          </div>
        </div>

        <p className="mt-8 text-center text-xs text-brand-gray">
          Apenas usuários do workspace <code className="text-brand-neon">a9p.com.br</code> podem acessar
        </p>
      </div>
    </main>
  );
